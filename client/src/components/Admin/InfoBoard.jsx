...
import AdminSideBar from './AdminSideBar';  // Ensure AdminSideBar component is imported correctly
import { useNavigate } from 'react-router-dom';
import '../../css/Admin/InfoBoard.css';
import '../../App.css'
                        ...
                        {filteredUsers.length > 0 ? (
                            filteredUsers.map(user => (
                                <tr key={user._id}>
                                    ...
                                    <td>{user.email}</td>
                                    <td>
                                        <button className="view-button" onClick={() => handleViewDetails(user._id)}>
                                            View
                                        </button>
                                    </td>
                                </tr>
