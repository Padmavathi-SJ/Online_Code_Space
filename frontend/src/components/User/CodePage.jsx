    ...
    <div className="container">
      ...
      <div className="left-half">
        ...
        <table className='test-case-table'>
          <thead>
            <tr>
              <th className='test-case-name'>Test Case</th>
              <th className='test-case-status'>Status</th>
            </tr>
          </thead>
          <tbody>
            {testCaseStatus.map((status, index) => (
              <tr key={index}>
                <td className='test-case-name'>Test Case {index + 1}</td>
