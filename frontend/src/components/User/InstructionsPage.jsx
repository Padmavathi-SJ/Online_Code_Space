...
import '../../css/User/InstructionsPage.css';
import '../../App.css';
          ...
          <div className="instruction-list">
            {[...Array(6)].map((_, index) => (
              <div key={index} className="instruction-item">
                ...
                />
                <label htmlFor={`instruction-${index}`}>Instruction ugin "react" was conflicted between "package.json » 
                eslint-config-react-app » E:\Compiler\Online-Coding-space-main\frontend\node_modules\eslint-config-react-app\base.js"
                ugin "react" was conflicted between "package.json » eslint-config-react-app {index + 1}</label>
              </div>
            ))}
          </div>
          <button
